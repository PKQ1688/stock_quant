...
stock_board_industry_cons_em_df.rename(columns=ch_eng_mapping_dict,
                                       inplace=True)
...
stock_board_industry_cons_em_df['pct'] = (stock_board_industry_cons_em_df['price'] / stock_board_industry_cons_em_df['pre_close'] - 1) * 100
stock_board_industry_cons_em_df.sort_values(by=['pct'],
                                            ascending=False,
                                            inplace=True)
